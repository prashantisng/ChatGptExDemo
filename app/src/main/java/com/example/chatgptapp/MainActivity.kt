    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        queryEdt.setOnEditorActionListener(TextView.OnEditorActionListener { v, actionId, event ->
            if (actionId==EditorInfo.IME_ACTION_SEND){
                //setting response on the below line
    ...
    private fun getResponse(query:String) {
        ...
        val postRequest: JsonObjectRequest =
            ...
            object : JsonObjectRequest(Method.POST, url, jsonObject,
                ...
                override fun getHeaders(): kotlin.collections.MutableMap<String, String> {
                    val params: MutableMap<String, String> = HashMap()
                    // adding headers on below line.
                    params["Content-Type"] = "application/json"
                    params["Authorization"] =
                        "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"
                    return params;
                }
            }
